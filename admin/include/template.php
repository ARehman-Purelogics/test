...
<table width="900" border="0" align="center" cellpadding="0" cellspacing="1" class="graybox">
  ...
  <tr>
    <td width="150" valign="top" class="navArea"><p>&nbsp;</p>
      ...
      <a href="<?php echo WEB_ROOT; ?>admin/bids" class="leftnav">Bids</a> 
...
<p>&nbsp;</p>
<p align="center">Copyright &copy; 2016- <?php echo date('Y'); ?> <a href="http://gcu.edu.pk"> Government College University, lahore</a></p>
</body>
</html>
